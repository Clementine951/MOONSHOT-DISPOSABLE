...
function CreatePage({ navigation }) {
  ...
  const handleValidate = async () => {
    ...
    try {
      ...
      // Listen for the App Clip URL to be generated by the Cloud Function
      const generateAppClipURL = onSnapshot(eventDocRef, (docSnapshot) => {
        const data = docSnapshot.data();
        if (data && data.appClipURL) {
          generateAppClipURL(); // Stop listening for updates once the URL is received
          Alert.alert('App Clip URL Generated', data.appClipURL);
          // navigation.navigate('HomeScreen');
        }
      });
